...
public interface KafkaYarnProtocol {
  ...
  java.lang.Void addInstance(int memory, int cores, int brokerId) throws org.apache.avro.AvroRemoteException;
  /** 停止 Kafka Instance */
  ...
  public interface Callback extends KafkaYarnProtocol {
    ...
    /** 添加启动 Kafka Instance, 默认为1, 可以启动多个 */
    void addInstance(int memory, int cores, int brokerId, org.apache.avro.ipc.Callback<java.lang.Void> callback) throws java.io.IOException;
    /** 停止 Kafka Instance */
